...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter recipeExporter) {
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.FRIDGE_A)
                .pattern("414")
                .pattern("232")
                .pattern("414")
                .input('1', concreteBlack)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.FRIDGE_B)
                .pattern("414")
                .pattern("232")
                .pattern("414")
                .input('1', concreteBlack)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.LAPTOP_CLOSED_PORTABLE_LAPTOP_STAND)
                .pattern("1")
                .pattern("2")
                .input('1', laptop)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.LED_FLOOR_LAMP, 2)
                .pattern(" 1 ")
                .pattern(" 2 ")
                .pattern("111")
                .input('1', concreteBlack)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.LED_FLOOR_LAMP_RGB_OFF, 2)
                .pattern(" 1")
                .pattern(" 2")
                .pattern("11")
                .input('1', concreteBlack)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.LED_RGB_TRIANGLE_PANEL)
                .pattern("12 ")
                .pattern("131")
                .pattern(" 21")
                .input('1', concreteBlack)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.MIDI_KEYBOARD_CONTROLLER)
                .pattern("111")
                .pattern("244")
                .pattern("311")
                .input('1', concreteBlack)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.MIDI_STANDALONE_GROOVEBOX)
                .pattern("111")
                .pattern("132")
                .pattern("222")
                .input('1', concreteBlack)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.MIDI_STANDALONE_GROOVEBOX_2)
                .pattern("424")
                .pattern("232")
                .pattern("121")
                .input('1', concreteBlack)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.MIDI_STANDALONE_GROOVEBOX_3)
                .pattern("11")
                .input('1', midiGroovebox)
                .criterion(hasItem(midiGroovebox), conditionsFromItem(midiGroovebox))
                .offerTo(recipeExporter);

        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.MODERN_BATHROOM_MIRROR_SHELF)
                .pattern("121")
                .pattern("111")
                .input('1', concreteBlack)
                .input('2', glassPane)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.MODERN_BATHROOM_SINK_STORAGE)
                .pattern(" 2 ")
                .pattern("111")
                .pattern("222")
                .input('1', concreteWhite)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.MONITOR_SETUP)
                .pattern("14")
                .pattern("23")
                .input('1', monitor)
                .input('2', keyboard)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.PLANT_POT)
                .pattern(" 3 ")
                .pattern("121")
                .input('1', ironIngot)
                .input('2', flowerPot)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.PORTABLE_LAPTOP_STAND)
                .pattern("1 1")
                .pattern("111")
                .pattern("1 1")
                .input('1', ironIngot)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.SOCKET, 4)
                .pattern("1")
                .pattern("2")
                .pattern("1")
                .input('1', concreteWhite)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.TOILET)
                .pattern("1  ")
                .pattern("111")
                .pattern("11 ")
                .input('1', concreteWhite)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.TV)
                .pattern("121")
                .pattern("131")
                .input('1', concreteBlack)
                .input('2', endCrystal)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.WASHING_MACHINE_AI)
                .pattern("121")
                .pattern("1 1")
                .pattern("131")
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.WHITE_GAMING_CHAIR)
                .pattern("1  ")
                .pattern("121")
                .pattern("3 3")
                .input('1', woolWhite)
