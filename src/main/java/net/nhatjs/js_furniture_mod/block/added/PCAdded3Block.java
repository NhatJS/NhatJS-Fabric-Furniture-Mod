...
public class PCAdded3Block extends PCHorizontalBlock {
    public PCAdded3Block(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if (held.isOf(ModItems.RAM)) {
            ...
            world.setBlockState(pos, ModBlocks.PC_ADDED_4.getDefaultState()
