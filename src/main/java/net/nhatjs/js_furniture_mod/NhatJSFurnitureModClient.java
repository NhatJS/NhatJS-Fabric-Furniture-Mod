...
import net.nhatjs.js_furniture_mod.block.blockentity.client.renderer.HologramRenderer;
...
public class NhatJSFurnitureModClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.HOLOGRAM, RenderLayer.getCutoutMipped());
        ...
        BlockEntityRendererRegistry.register(ModBlockEntities.HOLOGRAM, HologramRenderer::new);
    }
}
