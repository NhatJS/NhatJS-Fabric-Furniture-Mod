...
public class PCAdded10Block extends PCHorizontalBlock {
    public PCAdded10Block(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if (held.isOf(ModItems.GPU)) {
            Direction facing =  state.get(HorizontalFacingBlock.FACING);
            world.setBlockState(pos, ModBlocks.PC_ADDED_11.getDefaultState()
