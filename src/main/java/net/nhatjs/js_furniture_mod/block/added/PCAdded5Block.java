...
public class PCAdded5Block extends PCHorizontalBlock {
    public PCAdded5Block(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if (held.isOf(ModItems.RAM)) {
            ...
            world.setBlockState(pos, ModBlocks.PC_ADDED_6.getDefaultState()
