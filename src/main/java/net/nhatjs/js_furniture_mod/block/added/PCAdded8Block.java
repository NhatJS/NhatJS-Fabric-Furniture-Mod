...
public class PCAdded8Block extends PCHorizontalBlock {
    public PCAdded8Block(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if (held.isOf(ModItems.COMPUTER_FAN)) {
            ...
            world.setBlockState(pos, ModBlocks.PC_ADDED_9.getDefaultState()
