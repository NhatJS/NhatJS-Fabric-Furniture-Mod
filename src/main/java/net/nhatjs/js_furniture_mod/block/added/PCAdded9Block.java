...
public class PCAdded9Block extends PCHorizontalBlock {
    public PCAdded9Block(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if (held.isOf(ModItems.COMPUTER_FAN)) {
            Direction facing =  state.get(HorizontalFacingBlock.FACING);
            world.setBlockState(pos, ModBlocks.PC_ADDED_10.getDefaultState()
