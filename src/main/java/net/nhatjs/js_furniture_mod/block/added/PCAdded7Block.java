...
public class PCAdded7Block extends PCHorizontalBlock {
    public PCAdded7Block(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if (held.isOf(ModItems.COMPUTER_FAN)) {
            ...
            world.setBlockState(pos, ModBlocks.PC_ADDED_8.getDefaultState()
