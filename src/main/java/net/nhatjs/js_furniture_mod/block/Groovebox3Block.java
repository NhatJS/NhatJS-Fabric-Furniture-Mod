...
public class Groovebox3Block extends FurnitureHorizontalBlock implements BlockEntityProvider {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        if (!world.isClient()) {
            ...
            if (!(entity instanceof MIDIBlockEntity groovebox3)) return ActionResult.PASS;
