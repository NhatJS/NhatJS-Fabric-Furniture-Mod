...
public class Groovebox2Block extends FurnitureHorizontalBlock implements BlockEntityProvider {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        if (!world.isClient) {
            ...
            if (!(entity instanceof MIDIBlockEntity groovebox2)) return ActionResult.PASS;
