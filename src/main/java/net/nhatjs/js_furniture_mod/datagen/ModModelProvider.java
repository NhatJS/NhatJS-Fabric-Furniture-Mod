...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BLACK_COMPARTMENT_STORAGE_CABINET);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BLACK_COMPUTER_MOUSE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BLACK_3_DRAWER_DRESSER);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BLACK_CHAIR);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BLACK_COFFEE_TABLE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BLACK_DESK);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BLACK_DESK_COLUMN);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BLACK_DRAWER_SINGLE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BLACK_GAMING_CHAIR);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BLACK_KEYBOARD);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BLACK_MIRROR);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BLACK_STANDING_DESK);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BLACK_STANDING_DESK_B);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BLACK_TABLE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BLACK_TV_STAND);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BOOKS);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.COMPUTER_CASE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.COMPUTER_MOUSE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.COOKTOP);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.FLOOR_STANDING_SPEAKER);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.FRIDGE_A);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.FRIDGE_B);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.KEYBOARD);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.MODERN_BATHROOM_MIRROR_SHELF);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.MODERN_BATHROOM_SINK_STORAGE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.MODERN_CHAIR);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.MODERN_CLOCK);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.MONITOR);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_ADDED_1);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_ADDED_2);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_ADDED_3);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_ADDED_4);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_ADDED_5);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_ADDED_6);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_ADDED_7);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_ADDED_8);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_ADDED_9);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_ADDED_10);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_ADDED_11);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_TOWER_GLASS);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PLANT_POT);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PORTABLE_LAPTOP_STAND);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.SHOWER);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WHITE_COMPARTMENT_STORAGE_CABINET);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WHITE_3_DRAWER_DRESSER);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WHITE_CHAIR);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WHITE_COFFEE_TABLE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WHITE_DESK);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WHITE_DESK_COLUMN);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WHITE_DRAWER_SINGLE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WHITE_GAMING_CHAIR);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WHITE_STANDING_DESK);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WHITE_STANDING_DESK_B);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WHITE_TABLE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WHITE_TV_STAND);

        registerHorizontalWithBoolean(blockStateModelGenerator, ModBlocks.WHITE_VERTICAL_BLINDS, Properties.HORIZONTAL_FACING,
                VerticalBlindsBlock.TURN_ON, id("white_vertical_blinds"), id("white_vertical_blinds_open"));

        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_COMPARTMENT_STORAGE_CABINET);
        registerHorizontal(blockStateModelGenerator, ModBlocks.WOOD_3_DRAWER_DRESSER, id("wood_light_3_drawer_dresser"));
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_3_DRAWER_DRESSER);
        registerHorizontal(blockStateModelGenerator, ModBlocks.WOOD_CHAIR, id("wood_light_chair"));
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_CHAIR);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_COFFEE_TABLE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_DRAWER_SINGLE);
        registerHorizontal(blockStateModelGenerator, ModBlocks.WOOD_DESK, id("wood_light_desk"));
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_DESK);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_KITCHEN_CABINET_BOTTOM);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_KITCHEN_CABINET_BOTTOM_2);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_KITCHEN_CABINET_BOTTOM_2_EXTRA);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_KITCHEN_CABINET_BOTTOM_B);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_KITCHEN_CABINET_BOTTOM_B_2);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_KITCHEN_CABINET_BOTTOM_B_WITH_SINK);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_KITCHEN_CABINET_BOTTOM_WITH_SINK);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_KITCHEN_CABINET_TOP);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_KITCHEN_CABINET_TOP_B);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_KITCHEN_COMPARTMENT_STORAGE_CABINET);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_KITCHEN_COMPARTMENT_STORAGE_CABINET_B);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_KITCHEN_DRAWERS);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_KITCHEN_DRAWERS_B);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_STANDING_DESK);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_STANDING_DESK_B);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_LIGHT_TABLE);
        registerHorizontal(blockStateModelGenerator, ModBlocks.WOOD_LIGHT_TV_STAND, id("wood_light_tv_stand"));
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_COMPARTMENT_STORAGE_CABINET);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_3_DRAWER_DRESSER);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_CHAIR);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_COFFEE_TABLE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_DRAWER_SINGLE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_DESK);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_KITCHEN_CABINET_BOTTOM);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_KITCHEN_CABINET_BOTTOM_2);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_KITCHEN_CABINET_BOTTOM_2_EXTRA);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_KITCHEN_CABINET_BOTTOM_B);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_KITCHEN_CABINET_BOTTOM_B_2);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_KITCHEN_CABINET_BOTTOM_B_WITH_SINK);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_KITCHEN_CABINET_BOTTOM_WITH_SINK);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_KITCHEN_CABINET_TOP);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_KITCHEN_CABINET_TOP_B);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_KITCHEN_COMPARTMENT_STORAGE_CABINET);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_KITCHEN_COMPARTMENT_STORAGE_CABINET_B);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_KITCHEN_DRAWERS);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_KITCHEN_DRAWERS_B);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_STANDING_DESK);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_STANDING_DESK_B);
        horizontalWithCustomModel(blockStateModelGenerator, ModBlocks.WOOD_MEDIUM_STRIPED_WALL, "medium_wood_striped_wall");
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_TABLE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WOOD_MEDIUM_TV_STAND);
